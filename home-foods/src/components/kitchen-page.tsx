...
type Kitchen = { isOnline: boolean; id: number; name: string; description: string | null; logoUrl: string | null; coverImageUrl: string | null; city: string | null; deliveryFee: number | null; estimatedMinutes: number | null; minimumOrder: number | null; menuItems: MenuItem[]; reviews: Array<{ rating: number }> };
