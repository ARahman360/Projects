...
export type StorageHash =
  StorageHashBase<'9eceda9b225dd63549754bab80b6e3f7be12106a9c15e93f43ffbbebe2aa6007'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Address: {
      ...
      readonly verificationHash: CodecTypes['pg/text@1']['output'] | null;
    ...
    readonly AdminAuditLog: {
      ...
      readonly nextValue: CodecTypes['pg/text@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly Cart: {
      readonly id: CodecTypes['pg/int4@1']['output'];
    ...
    readonly NewsletterSubscriber: {
      ...
      readonly consentAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly Order: {
      ...
      readonly isSandbox: CodecTypes['pg/bool@1']['output'];
      readonly status:
        | 'PENDING'
        | 'CONFIRMED'
        | 'PREPARING'
    ...
    readonly OrderStatusEvent: {
      ...
      readonly actorRole: CodecTypes['pg/text@1']['output'];
    ...
    readonly Subscription: {
      ...
      readonly addressId: CodecTypes['pg/int4@1']['output'] | null;
      readonly deliveryTime: CodecTypes['pg/text@1']['output'] | null;
      readonly portions: CodecTypes['pg/int4@1']['output'];
    ...
    readonly SubscriptionPlan: {
      ...
      readonly name: CodecTypes['pg/text@1']['output'];
      readonly description: CodecTypes['pg/text@1']['output'] | null;
      readonly type: 'DAILY' | 'THREE_DAY' | 'WEEKLY' | 'MONTHLY';
      readonly price: CodecTypes['pg/float8@1']['output'];
      readonly currency: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Address: {
      ...
      readonly verificationHash: CodecTypes['pg/text@1']['input'] | null;
    ...
    readonly AdminAuditLog: {
      ...
      readonly nextValue: CodecTypes['pg/text@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly Cart: {
      readonly id: CodecTypes['pg/int4@1']['input'];
    ...
    readonly NewsletterSubscriber: {
      ...
      readonly consentAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly Order: {
      ...
      readonly isSandbox: CodecTypes['pg/bool@1']['input'];
      readonly status:
        | 'PENDING'
        | 'CONFIRMED'
        | 'PREPARING'
    ...
    readonly OrderStatusEvent: {
      ...
      readonly actorRole: CodecTypes['pg/text@1']['input'];
    ...
    readonly ScheduledMeal: {
      ...
      readonly billingEventKey: CodecTypes['pg/text@1']['input'] | null;
      readonly sequence: CodecTypes['pg/int4@1']['input'] | null;
      readonly scheduledAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly timeZone: CodecTypes['pg/text@1']['input'];
      readonly status: CodecTypes['pg/text@1']['input'];
      readonly portions: CodecTypes['pg/int4@1']['input'];
    ...
    readonly ScheduledMealEvent: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly scheduledMealId: CodecTypes['pg/int4@1']['input'];
      readonly status: CodecTypes['pg/text@1']['input'];
      readonly actorId: CodecTypes['pg/int4@1']['input'] | null;
      readonly actorRole: CodecTypes['pg/text@1']['input'];
      readonly message: CodecTypes['pg/text@1']['input'] | null;
    ...
    readonly Subscription: {
      ...
      readonly addressId: CodecTypes['pg/int4@1']['input'] | null;
      readonly deliveryTime: CodecTypes['pg/text@1']['input'] | null;
      readonly portions: CodecTypes['pg/int4@1']['input'];
...
export namespace Models {
  ...
  export type public_Shop = {
    ...
    isOnline: CodecTypes['pg/bool@1']['output'];
    ...
    customerFavorites: public_KitchenFavorite[];
    favorites: public_Favorite[];
  ...
  export type public_MenuItem = {
    ...
    shop: public_Shop;
    subscriptionPlanItems: public_SubscriptionPlanItem[];
    readonly [RelationKeys]?:
      | 'cartItems'
      | 'category'
      | 'favorites'
  ...
  export type public_Address = {
    ...
    countryCode: CodecTypes['pg/text@1']['output'] | null;
    verificationSource: CodecTypes['pg/text@1']['output'] | null;
    verificationHash: CodecTypes['pg/text@1']['output'] | null;
    ...
    subscriptions: public_Subscription[];
    user: public_User;
    readonly [RelationKeys]?: 'orders' | 'subscriptions' | 'user';
  };
  ...
  export type public_Order = {
    ...
    isSandbox: CodecTypes['pg/bool@1']['output'];
    status:
      | 'PENDING'
      | 'CONFIRMED'
      | 'PREPARING'
    ...
    scheduledMeal: public_ScheduledMeal | null;
    shop: public_Shop;
    statusEvents: public_OrderStatusEvent[];
    readonly [RelationKeys]?:
      | 'address'
      | 'customer'
      | 'delivery'
  ...
  export type public_CheckoutRequest = {
  ...
  export type public_SubscriptionPlan = {
    ...
    name: CodecTypes['pg/text@1']['output'];
    description: CodecTypes['pg/text@1']['output'] | null;
    type: 'DAILY' | 'THREE_DAY' | 'WEEKLY' | 'MONTHLY';
    price: CodecTypes['pg/float8@1']['output'];
    currency: CodecTypes['pg/text@1']['output'];
    ...
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    items: public_SubscriptionPlanItem[];
    shop: public_Shop;
    subscriptions: public_Subscription[];
    readonly [RelationKeys]?: 'items' | 'shop' | 'subscriptions';
  };
  export type public_SubscriptionPlanItem = {
    id: CodecTypes['pg/int4@1']['output'];
    ...
    readonly [RelationKeys]?: 'menuItem' | 'plan';
  };
  export type public_Subscription = {
    ...
    addressId: CodecTypes['pg/int4@1']['output'] | null;
    deliveryTime: CodecTypes['pg/text@1']['output'] | null;
    portions: CodecTypes['pg/int4@1']['output'];
    ...
    customer: public_User;
    plan: public_SubscriptionPlan;
    scheduledMeals: public_ScheduledMeal[];
    readonly [RelationKeys]?: 'address' | 'customer' | 'plan' | 'scheduledMeals';
  };
  export type public_ScheduledMeal = {
    id: CodecTypes['pg/int4@1']['output'];
    subscriptionId: CodecTypes['pg/int4@1']['output'];
    orderId: CodecTypes['pg/int4@1']['output'] | null;
    billingEventKey: CodecTypes['pg/text@1']['output'] | null;
    sequence: CodecTypes['pg/int4@1']['output'] | null;
    ...
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    events: public_ScheduledMealEvent[];
    order: public_Order | null;
    subscription: public_Subscription;
    readonly [RelationKeys]?: 'events' | 'order' | 'subscription';
  };
  export type public_ScheduledMealEvent = {
    id: CodecTypes['pg/int4@1']['output'];
    scheduledMealId: CodecTypes['pg/int4@1']['output'];
    status: CodecTypes['pg/text@1']['output'];
    actorId: CodecTypes['pg/int4@1']['output'] | null;
    actorRole: CodecTypes['pg/text@1']['output'];
    message: CodecTypes['pg/text@1']['output'] | null;
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    scheduledMeal: public_ScheduledMeal;
    readonly [RelationKeys]?: 'scheduledMeal';
  };
  ...
  export type public_Favorite = {
    ...
    menuItem: public_MenuItem;
    shop: public_Shop;
    readonly [RelationKeys]?: 'customer' | 'menuItem' | 'shop';
  };
  ...
  export type public_KitchenFavorite = {
    id: CodecTypes['pg/int4@1']['output'];
    customerId: CodecTypes['pg/int4@1']['output'];
    shopId: CodecTypes['pg/int4@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    customer: public_User;
    shop: public_Shop;
    readonly [RelationKeys]?: 'customer' | 'shop';
  };
  export type public_NewsletterSubscriber = {
    id: CodecTypes['pg/int4@1']['output'];
    email: CodecTypes['pg/text@1']['output'];
    consentAt: CodecTypes['pg/timestamptz-string@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    readonly [RelationKeys]?: never;
  };
  export type public_AdminAuditLog = {
    ...
    nextValue: CodecTypes['pg/text@1']['output'] | null;
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    readonly [RelationKeys]?: never;
  };
}
...
export declare const models: {
  public: {
    ...
    CheckoutRequest: Models.public_CheckoutRequest;
    OrderItem: Models.public_OrderItem;
    OrderStatusEvent: Models.public_OrderStatusEvent;
    ...
    SubscriptionPlanItem: Models.public_SubscriptionPlanItem;
    Subscription: Models.public_Subscription;
    ScheduledMeal: Models.public_ScheduledMeal;
    ScheduledMealEvent: Models.public_ScheduledMealEvent;
    Review: Models.public_Review;
    Favorite: Models.public_Favorite;
    PasswordResetToken: Models.public_PasswordResetToken;
    KitchenFavorite: Models.public_KitchenFavorite;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly checkoutRequest: {
              ...
              indexes: readonly [
                {
                  readonly name: 'checkoutRequest_userId_idx_a489d58a';
                  readonly prefix: 'checkoutRequest_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly favorite: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['customerId', 'menuItemId'] }];
              indexes: readonly [
                {
                  readonly name: 'favorite_shopId_idx_e9207c6b';
                  readonly prefix: 'favorite_shopId_idx';
                  readonly columns: readonly ['shopId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'favorite_menuItemId_idx_715cce4c';
                  readonly prefix: 'favorite_menuItemId_idx';
                  readonly columns: readonly ['menuItemId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'favorite_customerId_idx_b2a8a46c';
                  readonly prefix: 'favorite_customerId_idx';
            ...
            readonly kitchenFavorite: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['customerId', 'shopId'] }];
              indexes: readonly [
                {
                  readonly name: 'kitchenFavorite_shopId_idx_e9207c6b';
                  readonly prefix: 'kitchenFavorite_shopId_idx';
                  readonly columns: readonly ['shopId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'kitchenFavorite_customerId_idx_b2a8a46c';
                  readonly prefix: 'kitchenFavorite_customerId_idx';
                  readonly columns: readonly ['customerId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'kitchenFavorite';
                    readonly columns: readonly ['customerId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly orderStatusEvent: {
              columns: {
                ...
                readonly domain: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'ORDER'>;
                  };
                };
                readonly actorId: {
                  readonly nativeType: 'int4';
              ...
              indexes: readonly [
                {
                  readonly name: 'orderStatusEvent_orderId_createdAt_idx_cf5e070a';
                  readonly prefix: 'orderStatusEvent_orderId_createdAt_idx';
                  readonly columns: readonly ['orderId', 'createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'orderStatusEvent_orderId_idx_d284871b';
                  readonly prefix: 'orderStatusEvent_orderId_idx';
                  readonly columns: readonly ['orderId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'orderStatusEvent';
                    readonly columns: readonly ['orderId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly passwordResetToken: {
              ...
              indexes: readonly [
                {
                  readonly name: 'passwordResetToken_userId_createdAt_idx_f726f04a';
                  readonly prefix: 'passwordResetToken_userId_createdAt_idx';
            ...
            readonly scheduledMeal: {
              columns: {
                ...
                readonly timeZone: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'Europe/Helsinki'>;
                  };
                };
                readonly status: {
                  readonly nativeType: 'text';
              ...
              uniques: readonly [
                { readonly columns: readonly ['orderId'] },
                { readonly columns: readonly ['subscriptionId', 'billingEventKey', 'sequence'] },
              ];
              indexes: readonly [
                {
                  readonly name: 'scheduledMeal_subscriptionId_scheduledAt_idx_886f07e4';
                  readonly prefix: 'scheduledMeal_subscriptionId_scheduledAt_idx';
                  readonly columns: readonly ['subscriptionId', 'scheduledAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'scheduledMeal_status_scheduledAt_idx_62252894';
                  readonly prefix: 'scheduledMeal_status_scheduledAt_idx';
                  readonly columns: readonly ['status', 'scheduledAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'scheduledMeal_subscriptionId_idx_edbe96bf';
                  readonly prefix: 'scheduledMeal_subscriptionId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'scheduledMeal';
                    readonly columns: readonly ['subscriptionId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly scheduledMealEvent: {
              ...
              indexes: readonly [
                {
                  readonly name: 'scheduledMealEvent_scheduledMealId_createdAt_idx_5f132ed1';
                  readonly prefix: 'scheduledMealEvent_scheduledMealId_createdAt_idx';
                  readonly columns: readonly ['scheduledMealId', 'createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'scheduledMealEvent_scheduledMealId_idx_2a701afb';
                  readonly prefix: 'scheduledMealEvent_scheduledMealId_idx';
                  readonly columns: readonly ['scheduledMealId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'scheduledMealEvent';
                    readonly columns: readonly ['scheduledMealId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly subscription: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'subscription_addressId_idx_a5ddb548';
                  readonly prefix: 'subscription_addressId_idx';
                  readonly columns: readonly ['addressId'];
                  readonly unique: false;
                },
                {
            ...
            readonly subscriptionPlan: {
              columns: {
                ...
                readonly currency: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'GBP'>;
                  };
                };
            ...
            readonly subscriptionPlanItem: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['planId', 'menuItemId'] }];
              indexes: readonly [
                {
                  readonly name: 'subscriptionPlanItem_menuItemId_idx_715cce4c';
                  readonly prefix: 'subscriptionPlanItem_menuItemId_idx';
                  readonly columns: readonly ['menuItemId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'subscriptionPlanItem_planId_idx_5b32079a';
                  readonly prefix: 'subscriptionPlanItem_planId_idx';
                  readonly columns: readonly ['planId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'subscriptionPlanItem';
                    readonly columns: readonly ['planId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly valueSet: {
            ...
            readonly SubscriptionPlanType: {
              readonly kind: 'valueSet';
              readonly values: readonly ['DAILY', 'THREE_DAY', 'WEEKLY', 'MONTHLY'];
            };
...
> & {
  ...
  readonly roots: {
    ...
    readonly checkoutRequest: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'CheckoutRequest';
    };
    ...
    readonly subscriptionPlanItem: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'SubscriptionPlanItem';
    };
    readonly subscription: {
      readonly namespace: 'public' & NamespaceId;
    ...
    readonly scheduledMeal: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'ScheduledMeal';
    };
    readonly scheduledMealEvent: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'ScheduledMealEvent';
    };
    ...
    readonly kitchenFavorite: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'KitchenFavorite';
    };
    readonly newsletterSubscriber: {
      readonly namespace: 'public' & NamespaceId;
      ...
      readonly public: {
        readonly models: {
          readonly Address: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly verificationHash: { readonly column: 'verificationHash' };
          ...
          readonly AdminAuditLog: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly nextValue: { readonly column: 'nextValue' };
                readonly createdAt: { readonly column: 'createdAt' };
              };
            };
          };
          ...
          readonly CheckoutRequest: {
            ...
            readonly relations: Record<string, never>;
            readonly storage: {
              readonly table: 'checkoutRequest';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
          ...
          readonly KitchenFavorite: {
            ...
            readonly storage: {
              readonly table: 'kitchenFavorite';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly customerId: { readonly column: 'customerId' };
          ...
          readonly MenuItem: {
            ...
            readonly relations: {
              ...
              readonly subscriptionPlanItems: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'SubscriptionPlanItem';
                };
          ...
          readonly NewsletterSubscriber: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly consentAt: { readonly column: 'consentAt' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
          ...
          readonly Order: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly isSandbox: { readonly column: 'isSandbox' };
                readonly status: { readonly column: 'status' };
          ...
          readonly OrderStatusEvent: {
            ...
            readonly storage: {
              readonly table: 'orderStatusEvent';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly orderId: { readonly column: 'orderId' };
          ...
          readonly ScheduledMeal: {
            ...
            readonly relations: {
              readonly events: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['scheduledMealId'];
                };
              };
              readonly order: {
                readonly to: {
            ...
            readonly storage: {
              readonly table: 'scheduledMeal';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly subscriptionId: { readonly column: 'subscriptionId' };
                readonly orderId: { readonly column: 'orderId' };
                readonly billingEventKey: { readonly column: 'billingEventKey' };
                ...
                readonly status: { readonly column: 'status' };
                readonly portions: { readonly column: 'portions' };
          ...
          readonly ScheduledMealEvent: {
            ...
            readonly relations: {
              readonly scheduledMeal: {
                ...
                readonly nullable: false;
                readonly on: {
                  readonly localFields: readonly ['scheduledMealId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              readonly table: 'scheduledMealEvent';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly scheduledMealId: { readonly column: 'scheduledMealId' };
                readonly status: { readonly column: 'status' };
                readonly actorId: { readonly column: 'actorId' };
                readonly actorRole: { readonly column: 'actorRole' };
                readonly message: { readonly column: 'message' };
          ...
          readonly Subscription: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly addressId: { readonly column: 'addressId' };
                readonly deliveryTime: { readonly column: 'deliveryTime' };
                readonly portions: { readonly column: 'portions' };
          ...
          readonly SubscriptionPlanItem: {
            ...
            readonly storage: {
              readonly table: 'subscriptionPlanItem';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly planId: { readonly column: 'planId' };
        ...
        readonly enum: {
          ...
          readonly SubscriptionPlanType: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'THREE_DAY'; readonly value: 'THREE_DAY' },
